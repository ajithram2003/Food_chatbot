...
app.mount("/static", StaticFiles(directory=r"D:\project\Tiffintalk-bot-main\frontend"), name="static")
...
async def serve_index():
    try:
        with open(r"D:\project\Tiffintalk-bot-main\frontend\index.html", "r") as f:
            html_content = f.read()
